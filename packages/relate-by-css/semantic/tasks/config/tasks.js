...
const basename = 'relate-by'; // 'semantic'
...
module.exports = {
  ...
  filenames: {
    concatenatedCSS            : `${basename}.css`,
    concatenatedJS             : `${basename}.js`,
    concatenatedMinifiedCSS    : `${basename}.min.css`,
    concatenatedMinifiedJS     : `${basename}.min.js`,
    concatenatedRTLCSS         : `${basename}.rtl.css`,
    concatenatedMinifiedRTLCSS : `${basename}.rtl.min.css`
  },
